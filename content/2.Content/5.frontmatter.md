...
| `table_of_contents`    |             | `boolean` | `true` shows the table of contents on this post (if the theme renders one). It can also be enabled for every post site-wide with the `table_of_contents` option in `app.config.ts` |
