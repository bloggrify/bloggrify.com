...
description: 'Learn how to change the theme of your blog.'
---
...
You can choose to install another theme like "Mistral", "Bento", or "Epoxia", or you can also look at the [other templates available](/templates).
...
2. Next, you have to specify the theme in the `app/app.config.ts` file:
