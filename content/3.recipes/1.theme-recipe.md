# Recipe : create a new theme from scratch
...
Create a new folder called `components/themes/neo-minimalist` in the root of your project. This folder will contain the components of your theme.

Create a new file called `home.vue` in the `components/themes/neo-minimalist` folder. This file will be the layout for the home page.
